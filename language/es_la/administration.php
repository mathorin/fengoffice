<?php return array(
	...
	'config option desc password_expiration' => 'Cantidad de días en los cuales la contraseña es válida (0para deshabilitar esta opción)',
	'config option name password_expiration_notification' => 'Notificación de expiración de contraseña (días antes)',
	'config option desc password_expiration_notification' => 'Cantidad de días para notificar al usuario antes de la expiración de su contraseña (0para deshabilitar esta opción)',
	...
	'config option desc new_password_char_difference' => 'Validar que la nueva contraseña difiera en por lo menos3caracteres con respecto a las últimas10contraseñas utilizadas por el usuario',
	'config option name validate_password_history' => 'Validar historial de contraseñas',
	'config option desc validate_password_history' => 'Validar que la nueva contraseña no coincida con ninguna de las últimas10contraseñas utilizadas por el usuario',
	'config option name block_login_after_x_tries' => 'Bloquear login luego de5intentos fallidos',
	'config option desc block_login_after_x_tries' => 'Si un usuario intenta loguearse al sistema más de5veces en los últimos10minutos con credenciales equivocadas, entonces su cuenta será bloqueada por10minutos.',
	...
	'config option desc use_owner_company_logo_at_header' => 'Coloca el logo de la organización propietaria en la parte superior izquerda de la pantalla. Debe recargar (F5) para aplicar los cambios. Tamaño recomendado:50x50px.',
	...
	'user config option desc date_format' => 'Formato en que se muestran las fechas. Códigos: d = Día (2dígitos, con ceros), D = Nombre del día (tres letras), j = Día, l = Nombre del día completo, m = Mes (con ceros), M = Nombre del mes (tres letras), n = Mes, F = Nombre del mes completo, Y = Año (4dígitos), y = Año (2dígitos). Debe recargar la página para aplicar los cambios.',
	...
	'user config option desc draft_autosave_timeout' => 'Cantidad de segundos entre cada autoguardado (0para deshabilitar)',
	...
	'config option name use_task_work_performed' => 'Utilizar horas trabajadas en tareas',
	'config option desc use_task_work_performed' => 'Permite ingresar horas trabajadas en cada tarea.',
	...
	'user config option desc time_format_use_24' => 'Si está habilitado el formato de hora será \'hh:mm\' desde00:00hasta23:59, sino las horas se utilizarán desde1a12utilizando AM o PM.',
	...
	'config option desc user_email_fetch_count' => 'Cuántos correos obtener al presionar el botón "Verificar cuentas de correo". Un valor muy grande puede causar errores de interrupción. Use0para no limitar la cantidad de correos. Nota, esta opción no afecta la obtención de correos por cron.',
	...
	'user config option desc mail_account_err_check_interval' => 'Cantidad de segundos entre cada chequeo de errores en las cuentas de correo (0para deshabilitar)',
	'user config option name contacts_per_page' => 'Contactos por página',
	'user config option desc contacts_per_page' => 'Cantidad de contactos listados (evite0y números negativos). Tenga en cuenta que cuanto mayor sea el número, más tiempo demorará en cargar el listado de contactos.',
...
{0}',
	...
	'object properties' => 'Propiedades de los objetos',
	...
	'user config option desc report_time_colums_display' => 'Si se selcciona el formato usual se mostrarán las fechas de forma descriptiva (ej.:2horas,15minutos), de lo contrario se mostrará la cantidad de minutos o segundos.',
	...
	'config option name use_mail_accounts_to_send_nots' => 'Usar cuentas de correo para enviar notas',
	'config option name track_send_mails' => 'Seguimiento de envío de correos',
	'config option name send_outbox_emails_in_background' => 'Enviar correos electrónicos de bandeja de salida en segundo plano',
	...
	'user config option name enable_archive_confirmation' => 'Mostrar ventana de confirmación al archivar objetos',
	'user config option name enable_trash_confirmation' => 'Mostrar ventana de confirmación al enviar objetos a la papelera',
	'member names' => 'Nombres de miembros',
	'member names desc' => 'En esta sección se puede cambiar el nombre de cada miembro, si se deja en blanco el campo \'Nombre personalizado\' se utilizará el nombre predeterminado.',
	...
	'config option name mandatory_email_on_contacts' => 'Correo Electrónico obligatorio en contactos',
	'config option desc mandatory_email_on_contacts' => 'Seleccionar si el Correo de electronico Prinicpal es obligatorio en los contactos.',
	...
	'config option name use_task_estimated_time' => 'Usar tiempo estimado en tareas',
	'config option desc use_task_estimated_time' => 'Permitir a los usuarios agregar Tiempo Estimado a la tarea',
	'config option name use_task_pending_time' => 'Usar tiempo presupuestado restante en tareas',
	'config option desc use_task_pending_time' => 'Si se usa el Tiempo Estimado, permitir a los usuarios ver el tiempo presupuestado restante',
	'config option name minimum_characters_dimension_search' => 'Número mínimo de caracteres para la búsqueda de dimensiones',
	'this email already exists for another user. please use a different email.' => 'Este correo electrónico ya existe para otro usuario. Por favor, utiliza un correo electrónico diferente.',
	'this email already exists for another contact. please use a different email.' => 'Este correo electrónico ya existe para otro contacto. Por favor, utiliza un correo electrónico diferente.',
	'user config option name tasksShowWorkPerformedDeleteAllButton' => 'Mostrar el botón "Eliminar todo"',
	'user config option desc tasksShowWorkPerformedDeleteAllButton' => 'Muestra el botón "Eliminar todo" en la descripción general de la tarea en la sección "Trabajo realizado"',
	'user config option desc noOfTasks' => 'La cantidad de tareas mostradas para cada grupo de tareas en el módulo de tareas, siempre puedes cargar más tareas si el grupo tiene más.',
	'dimensions that can be applied to widgets' => 'Dimensiones que se pueden aplicar a los widgets',
	'can_see_others_timeslots' => 'Puede ver las entradas de tiempo de otros usuarios',
	'can_see_expenses_of_others' => 'Puede ver los gastos pagados por otros usuarios',
	'can_see_expenses_of_others description' => 'Si está habilitado, el usuario podrá ver gastos que no fueron pagados por él/ella.',
	'can_see_others_timeslots description' => 'Si está habilitado, el usuario podrá ver las entradas de tiempo que no fueron ingresados por él/ella.',
	'user config option name pdf_page_layout' => 'Establecer diseño de página PDF predeterminado',
	'config_pdf_layout_portrait' => 'Vertical',
	'config_pdf_layout_landscape' => 'Horizontal',
	'user config option name pdf_page_size' => 'Establecer tamaño de página PDF predeterminado',
	...
	'config_pdf_size_letter' => 'Carta',
	'config_allow_stop_timer' => 'Detener temporizador en ejecución (si lo hay)',
	'config_allow_pause_timer' => 'Pausar todos los temporizadores en ejecución (si los hay)',
	'config_let_timer_continue' => 'Permitir que todos los temporizadores iniciados continúen en ejecución',
