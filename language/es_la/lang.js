...
addLangs({
  ...
  'mark as started this task': 'Marcar esta tarea como iniciada',
  'unmark as started this task': 'Desmarcar esta tarea como iniciada',
  'mark as started': 'Marcar como iniciada',
  ...
  'error delete people parametric': 'No puede enviar a la papelera Usuarios \n{0}Debe hacerlo desde el Panel de Administración\n',
  'error delete company parametric': 'No puede enviar a la papelera Compañias \n{0}que contienen Usuarios o Contactos\n',
  ...
  'do you want to mantain the current associations of this obj with members of': '¿Desea reemplazar la actual asociación con {0}, o mantener ambas?',
  'replace with the new one': 'Reemplazar con la nueva',
  'keep both current and new': 'Mantener ambas - actual y nueva',
  ...
  'create email rule title': 'Crear regla de correo',
  ...
  'quick mark as started': 'Acceso rápido a marcar como iniciada',
  ...
  "the user assign to this task doesn't have permission over the selected project. The task is now unassigned": "El usuario asignado a esta tarea no tiene permisos sobre esta clasificación. La tarea ha sido desasignada.",

	'last updated on': 'Última actualización el',
	'confirm delete time': '¿Estás seguro de que deseas eliminar la entrada de tiempo?',
	'confirm discard work timeslot': '¿Estás seguro de que deseas descartar la entrada de tiempo actual?',
	'end': 'Fin',
	'total worked time': 'Tiempo total trabajado',
	'total worked': 'Total trabajado',
	'this month': 'Este mes',
	'this week': 'Esta semana',
	'discard_work': 'Descartar trabajo en esta tarea',
  ...
  'move selected objects to trash': 'Mover los objetos seleccionados a la papelera',
  'confirm move to trash': '¿Está seguro que desea enviar los objetos seleccionados a la papelera?',
  'confirm restore objects': '¿Está seguro que desea restaurar los objetos seleccionados?',
  'archive': 'Archivar',
  'new': 'New',
